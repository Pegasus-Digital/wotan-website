        ...
        <>
          <div className='flex flex-row items-center justify-center gap-2 text-sm font-bold'>
            ...
            <Button variant='default' size='sm' asChild>
              <Link
                href={`/sistema/orcamentos/${typeof order.ogBudget === 'object' ? order.ogBudget.incrementalId : ''}`}
              ...
              return index < 3 ? (
                ...
                index === 3 && (
                  <Button variant='outline' className='w-full'>
                    <Link
                      href={`/sistema/catalogo/busca-avancada?query=${encodeURIComponent(searchTerm)}`}

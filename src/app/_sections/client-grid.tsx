  ...
  return (
    <section className='w-full overflow-hidden'>
      <div className='container flex flex-col items-center justify-center pb-6'>
        ...
        <div className='grid max-w-screen-desktop grid-cols-2 gap-4 tablet:grid-cols-4 tablet:gap-6 desktop:grid-cols-5'>
          {clients.map((client, index) => (
            <div
              key={index}
              className='m-2  flex aspect-square h-full  max-h-48  max-w-48 items-center justify-center overflow-hidden rounded-md bg-white object-cover p-2 shadow-wotan-light'
            >
              <Image
                key={index}
